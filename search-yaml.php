...
if (!empty($spotter_array))
{
  foreach($spotter_array as $spotter_item)
  {
    ...
    $output .= "\n";
    $output .= ' - aircraft: '.$spotter_item['aircraft_name'].' ('.$spotter_item['aircraft_type'].')';
    $output .= "\n";
    $output .= ' - airline: '.$spotter_item['airline_name'];
    $output .= "\n";
    $output .= ' - departure-airport: '.$spotter_item['departure_airport_city'].' '.$spotter_item['departure_airport_name'].' '.$spotter_item['departure_airport_country'].' ('.$spotter_item['departure_airport'].')';
    $output .= "\n";
    $output .= ' - arrival-airport: '.$spotter_item['arrival_airport_city'].' '.$spotter_item['arrival_airport_name'].' '.$spotter_item['arrival_airport_country'].' ('.$spotter_item['arrival_airport'].')';
    $output .= "\n";
