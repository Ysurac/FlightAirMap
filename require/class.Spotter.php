  ...
  /**
	...
	*/
	public static function install($domain)
	{
		...
		//aircraft registration import
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_HEADER, 0);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		curl_setopt($ch, CURLOPT_URL, $domain.'/db/aircraft_registration.sql');
		$import_sql = curl_exec($ch);
		curl_close($ch);
		...
		curl_setopt($ch, CURLOPT_HEADER, 0);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		curl_setopt($ch, CURLOPT_URL, $domain.'/db/aircraft.sql');
		$import_sql = curl_exec($ch);
		curl_close($ch);
		...
		curl_setopt($ch, CURLOPT_HEADER, 0);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		curl_setopt($ch, CURLOPT_URL, $domain.'/db/airlines.sql');
		$import_sql = curl_exec($ch);
		curl_close($ch);
		...
		curl_setopt($ch, CURLOPT_HEADER, 0);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		curl_setopt($ch, CURLOPT_URL, $domain.'/db/airport.sql');
		$import_sql = curl_exec($ch);
		curl_close($ch);
		...
		//spotter_output import - structure only
		$ch = curl_init();
		curl_setopt($ch, CURLOPT_HEADER, 0);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		curl_setopt($ch, CURLOPT_URL, $domain.'/db/spotter_output.sql');
		$import_sql = curl_exec($ch);
		curl_close($ch);
