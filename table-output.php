	...
	if (strtolower($current_page) == "acars-latest" || strtolower($current_page) == "acars-archive") {
		if ($spotter_item['image_thumbnail'] != "")
		{
			...
			if (isset($spotter_item['airline_name'])) {
				print '<img src="'.$spotter_item['image_thumbnail'].'" class="img-rounded" data-toggle="popover" title="'.$spotter_item['registration'].' - '.$spotter_item['airline_name'].'" alt="'.$spotter_item['registration'].' - '.$spotter_item['airline_name'].'" data-content="Registration: '.$spotter_item['registration'].'<br />Airline: '.$spotter_item['airline_name'].'<br />Image copyright : '.$spotter_item['image_copyright'].'" data-html="true" width="100px" />'."\n";
			} else {
				print '<img src="'.$spotter_item['image_thumbnail'].'" class="img-rounded" data-toggle="popover" title="'.$spotter_item['registration'].' - Not available" alt="'.$spotter_item['registration'].' - Not available" data-content="Registration: '.$spotter_item['registration'].'<br />Airline: Not available<br />Image copyright : '.$spotter_item['image_copyright'].'" data-html="true" width="100px" />'."\n";
			}
			print '</td>'."\n";
		} else {
			print '<td class="aircraft_thumbnail">'."\n";
