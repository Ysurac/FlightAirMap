...
if (!empty($airport_array))
{
  ...
  print '<div class="column">';
  	...
  	?>
  	<p>The statistic below shows all departure airports by Country of origin of flights to <strong><?php print $airport_array[0]['city'].', '.$airport_array[0]['name'].' ('.$airport_array[0]['icao'].')'; ?></strong>.</p>
  	<?php
    	 $airport_country_array = $Spotter->countAllDepartureAirportCountriesByAirport($_GET['airport']);
