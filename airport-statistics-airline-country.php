...
{
	$title = _("Most Common Airlines by Country to/from").' '.$airport_array[0]['city'].', '.$airport_array[0]['name'].' ('.$airport_array[0]['icao'].')';
	...
	print '<p>'._("The statistic below shows the most common airlines by Country of origin of flights to/from").' <strong>'.$airport_array[0]['city'].', '.$airport_array[0]['name'].' ('.$airport_array[0]['icao'].')</strong>.</p>';
