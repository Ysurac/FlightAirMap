...
{
	$title = 'Most Common Arrival Airports by Country for '.$spotter_array[0]['aircraft_name'].' ('.$spotter_array[0]['aircraft_type'].')';
	...
	print '<h2>Most Common Arrival Airports by Country</h2>';
  	?>
  	 <p>The statistic below shows all arrival airports by Country of origin of flights from <strong><?php print $spotter_array[0]['aircraft_name']; ?> (<?php print $spotter_array[0]['aircraft_type']; ?>)</strong>.</p>
