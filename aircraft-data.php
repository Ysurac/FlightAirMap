...
if (isset($globalVATSIM) && $globalVATSIM && isset($globalIVAO) && $globalIVAO && isset($spotter_item['format_source']) && $spotter_item['format_source'] != '') print '<div class="waypoints"><span>Source</span>'.$spotter_item['format_source'].'</div>';
