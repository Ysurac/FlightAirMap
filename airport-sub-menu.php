	...
	<ul class="nav nav-pills">
		...
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/airport/statistics/aircraft/<?php print $_GET['airport']; ?>"><?php echo _("Aircraft Type"); ?></a></li>
					<li><a href="<?php print $globalURL; ?>/airport/statistics/registration/<?php print $_GET['airport']; ?>"><?php echo _("Registration"); ?></a></li>
					<li><a href="<?php print $globalURL; ?>/airport/statistics/manufacturer/<?php print $_GET['airport']; ?>"><?php echo _("Manufacturer"); ?></a></li>
		    </ul>
		</li>
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/airport/statistics/airline/<?php print $_GET['airport']; ?>"><?php echo _("Airline"); ?></a></li>
			  <li><a href="<?php print $globalURL; ?>/airport/statistics/airline-country/<?php print $_GET['airport']; ?>"><?php echo _("Airline by Country"); ?></a></li>
		    </ul>
		</li>
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/airport/statistics/departure-airport/<?php print $_GET['airport']; ?>"><?php echo _("Departure Airport"); ?></a></li>
		      <li><a href="<?php print $globalURL; ?>/airport/statistics/departure-airport-country/<?php print $_GET['airport']; ?>"><?php echo _("Departure Airport by Country"); ?></a></li>
			  <li><a href="<?php print $globalURL; ?>/airport/statistics/arrival-airport/<?php print $_GET['airport']; ?>"><?php echo _("Arrival Airport"); ?></a></li>
