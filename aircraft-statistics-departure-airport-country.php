...
{
	$title = _("Most Common Departure Airports by Country for").' '.$spotter_array[0]['aircraft_name'].' ('.$spotter_array[0]['aircraft_type'].')';
	...
	print '<p>'._("The statistic below shows all departure airports by Country of origin of flights from").' <strong>'.$spotter_array[0]['aircraft_name'].' ('.$spotter_array[0]['aircraft_type'].')</strong>.</p>';
