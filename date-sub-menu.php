	...
	<ul class="nav nav-pills">
		...
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/date/statistics/aircraft/<?php print $date; ?>"><?php echo _("Aircraft Type"); ?></a></li>
					<li><a href="<?php print $globalURL; ?>/date/statistics/registration/<?php print $date; ?>"><?php echo _("Registration"); ?></a></li>
					<li><a href="<?php print $globalURL; ?>/date/statistics/manufacturer/<?php print $date; ?>"><?php echo _("Manufacturer"); ?></a></li>
		    </ul>
		</li>
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/date/statistics/airline/<?php print $date; ?>"><?php echo _("Airline"); ?></a></li>
			  <li><a href="<?php print $globalURL; ?>/date/statistics/airline-country/<?php print $date; ?>"><?php echo _("Airline by Country"); ?></a></li>
		    </ul>
		</li>
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/date/statistics/departure-airport/<?php print $date; ?>"><?php echo _("Departure Airport"); ?></a></li>
		      <li><a href="<?php print $globalURL; ?>/date/statistics/departure-airport-country/<?php print $date; ?>"><?php echo _("Departure Airport by Country"); ?></a></li>
			  <li><a href="<?php print $globalURL; ?>/date/statistics/arrival-airport/<?php print $date; ?>"><?php echo _("Arrival Airport"); ?></a></li>
