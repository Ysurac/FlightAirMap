...
<!--
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/ident/statistics/aircraft/<?php print $_GET['ident']; ?>"><?php echo _("Aircraft Type"); ?></a></li>
					<li><a href="<?php print $globalURL; ?>/ident/statistics/registration/<?php print $_GET['ident']; ?>"><?php echo _("Registration"); ?></a></li>
					<li><a href="<?php print $globalURL; ?>/ident/statistics/manufacturer/<?php print $_GET['ident']; ?>"><?php echo _("Manufacturer"); ?></a></li>
		    </ul>
		</li>
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/ident/statistics/departure-airport/<?php print $_GET['ident']; ?>"><?php echo _("Departure Airport"); ?></a></li>
		      <li><a href="<?php print $globalURL; ?>/ident/statistics/departure-airport-country/<?php print $_GET['ident']; ?>"><?php echo _("Departure Airport by Country"); ?></a></li>
			  <li><a href="<?php print $globalURL; ?>/ident/statistics/arrival-airport/<?php print $_GET['ident']; ?>"><?php echo _("Arrival Airport"); ?></a></li>
