	...
	<ul class="nav nav-pills">
		...
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/manufacturer/statistics/aircraft/<?php print $_GET['aircraft_manufacturer']; ?>"><?php echo _("Aircraft Type"); ?></a></li>
			  <li><a href="<?php print $globalURL; ?>/manufacturer/statistics/registration/<?php print $_GET['aircraft_manufacturer']; ?>"><?php echo _("Registration"); ?></a></li>
		    </ul>
		</li>
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/manufacturer/statistics/airline/<?php print $_GET['aircraft_manufacturer']; ?>"><?php echo _("Airline"); ?></a></li>
		      <li><a href="<?php print $globalURL; ?>/manufacturer/statistics/airline-country/<?php print $_GET['aircraft_manufacturer']; ?>"><?php echo _("Airline by Country"); ?></a></li>
		    </ul>
		</li>
		<li class="dropdown">
		    ...
		    <ul class="dropdown-menu" role="menu">
		      <li><a href="<?php print $globalURL; ?>/manufacturer/statistics/departure-airport/<?php print $_GET['aircraft_manufacturer']; ?>"><?php echo _("Departure Airport"); ?></a></li>
		      <li><a href="<?php print $globalURL; ?>/manufacturer/statistics/departure-airport-country/<?php print $_GET['aircraft_manufacturer']; ?>"><?php echo _("Departure Airport by Country"); ?></a></li>
			  <li><a href="<?php print $globalURL; ?>/manufacturer/statistics/arrival-airport/<?php print $_GET['aircraft_manufacturer']; ?>"><?php echo _("Arrival Airport"); ?></a></li>
